...
use DeployTeam\Intercall\Transports\RedisOutboundTransport;

class RedisOutboundTransportFactory
{
    ...
    public function create(RedisOutboundConfig $config): RedisOutboundTransport
    {
        ...
        return new RedisOutboundTransport(
            $redis,
            $this->serializer,
            $this->logger,
            $config,
